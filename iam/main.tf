...
locals {
  ...
  # agents', dotfiles', agent-memory-server's, and project-starter-template's
  # pr-code-review.yml (#220, #307, #368): all ID-pinned, :pull_request since the trigger is pull_request.
  pr_review_openrouter_subs = [
    ...
    local.amem_sub_pr,
    "${local.pst_sub_prefix}:pull_request",
  ]
